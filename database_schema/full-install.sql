DROP DATABASE IF EXISTS bookedscheduler;

CREATE DATABASE bookedscheduler;

USE bookedscheduler;
GRANT ALL on bookedscheduler.* to 'booked_user'@'localhost' identified by 'password';SET foreign_key_checks = 0;
