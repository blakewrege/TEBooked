...
$conf['settings']['phpmailer']['smtp.host'] = 'smtp.google.com';
$conf['settings']['phpmailer']['smtp.port'] = '465';
$conf['settings']['phpmailer']['smtp.secure'] = 'ssl';
$conf['settings']['phpmailer']['smtp.auth'] = 'true';
$conf['settings']['phpmailer']['smtp.username'] = 'redmine.thermaltech@gmail.com';
$conf['settings']['phpmailer']['smtp.password'] = 'two%milk';
